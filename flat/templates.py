		...
		class Publisher:
			...
			def format(baseDirectoryPath:str, targetFileName:str, **kwargs:dict) -> dict:
				...
				dictionary["cas-common.sty"] = [
					...
					"\\NewDocumentCommand \\wrAun { m }      ",
					"   { \\iow_now:Nn \\@auxout { #1 } }",
					"\\NewDocumentCommand \\wrAux { m }      ",
					"   { \\iow_now:Nx \\@auxout { #1 } }",
					"\\NewDocumentCommand \\wrShipAux { m }   ",
					"   { \\iow_shipout:Nx \\@auxout { #1 } }",
					"\\NewDocumentCommand \\wrShipAun { m }   ",
					...
					"   {\\rightskip=0pt\\rmfamily\\small\\textbf{\\color{scolor}#1:}~#2\\par }",
